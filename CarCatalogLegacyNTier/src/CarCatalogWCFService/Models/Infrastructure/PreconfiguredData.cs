...
namespace CarCatalogWCFService.Models.Infrastructure
{
    public static class PreconfiguredData
    {
        public static List<CatalogItem> GetPreconfiguredCatalogItems()
        {
            ...
            {
                new CatalogItem { Id =1, CatalogTypeId = 1, CatalogBrandId = 1, Description = "Velocari Strada SV plug-in hybrid supercar with 1000 cv", Name = "Velocari Strada SV", Price = 507000M, Picturefilename = "2.png" },
                new CatalogItem { Id =2, CatalogTypeId = 1, CatalogBrandId = 1, Description = "Velocari Tipo 6 with 663 cv V6 hybrid powertrain", Name = "Velocari Tipo 6", Price = 320000M, Picturefilename = "11.png" },
                new CatalogItem { Id =3, CatalogTypeId = 2, CatalogBrandId = 1, Description = "Velocari Aurora GT front-engined V8 grand tourer", Name = "Velocari Aurora GT", Price = 222000M, Picturefilename = "7.png" },
                new CatalogItem { Id =4, CatalogTypeId = 3, CatalogBrandId = 1, Description = "Velocari Terra X four-door four-seater V12", Name = "Velocari Terra X", Price = 390000M, Picturefilename = "5.png" },
                new CatalogItem { Id =5, CatalogTypeId = 1, CatalogBrandId = 2, Description = "Toranti Furente V12 hybrid flagship", Name = "Toranti Furente", Price = 517000M, Picturefilename = "9.png" },
                new CatalogItem { Id =6, CatalogTypeId = 3, CatalogBrandId = 2, Description = "Toranti Monte S super SUV", Name = "Toranti Monte S", Price = 260000M, Picturefilename = "1.png" },
                new CatalogItem { Id =7, CatalogTypeId = 1, CatalogBrandId = 3, Description = "Nordwerk RS9 track-focused flat-six", Name = "Nordwerk RS9", Price = 241000M, Picturefilename = "6.png" },
                new CatalogItem { Id =8, CatalogTypeId = 3, CatalogBrandId = 3, Description = "Nordwerk Terra Turbo performance SUV", Name = "Nordwerk Terra Turbo", Price = 198000M, Picturefilename = "3.png" },
                new CatalogItem { Id =9, CatalogTypeId = 1, CatalogBrandId = 4, Description = "Aurelia Nettare S with twin-turbo V6 and carbon tub", Name = "Aurelia Nettare S", Price = 240000M, Picturefilename = "12.png" },
                new CatalogItem { Id =10, CatalogTypeId = 2, CatalogBrandId = 4, Description = "Aurelia Granluce V6 grand tourer", Name = "Aurelia Granluce", Price = 175000M, Picturefilename = "8.png" },
